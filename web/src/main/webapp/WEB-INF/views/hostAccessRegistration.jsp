...
<head>
    ...
    <title>Host Access Registration Form</title>
...
<div class="generic-container">
    ...
    <div class="well lead">Host Access Registration Form</div>
    <form:form method="POST" modelAttribute="hostAccess" class="form-horizontal">
        <%--<form:input type="hidden" path="host" hostId="host"/>--%>
        ...
        <div class="row">
            <div class="form-actions floatRight">
                <c:choose>
                    <c:when test="${edit}">
                        <input type="submit" value="Update" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/hostList' />">Cancel</a>
                    </c:when>
                    <c:otherwise>
                        <input type="submit" value="Register" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/hostList' />">Cancel</a>
                    </c:otherwise>
                </c:choose>
            </div>
        </div>
